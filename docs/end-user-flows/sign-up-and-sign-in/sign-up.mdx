...
### Type 1: Username with password creation \{#type-1-username-with-password-creation}
...
### Type 2: Email address or phone number with verification flow \{#type-2-email-address-or-phone-number-with-verification-flow}
...
### Type 3: Email address with verification and password creation \{#type-3-email-address-with-verification-and-password-creation}
...
### Collect additional user information on sign-up \{#collect-additional-user-information-on-sign-up}

</summary>

To collect additional user profile information (e.g., Full name, Birthday, Company name) during sign-up, you now have two options:
...
- **Bring your own UI**: Customize your own sign-up flow using our [bring your own UI](/customization/bring-your-ui) feature with user profile settings API.
...
### Admin-created users / Invited users \{#admin-created-users--invited-users}
...
### Embedded sign-up forms on your website \{#embedded-sign-up-forms-on-your-website}
...
### Sending welcome emails to new users \{#sending-welcome-emails-to-new-users}
...
### Skip email verification on sign-up \{#skip-email-verification-on-sign-up}
